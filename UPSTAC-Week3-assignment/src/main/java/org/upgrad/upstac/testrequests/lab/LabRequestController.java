...
public class LabRequestController {
    ...
    public List<TestRequest> getForTester()  {
        ...
        // fetch current logged in user from JWT token context
        final User tester =userLoggedInService.getLoggedInUser();
        /*
        fetch final list of tests which can used by tester to work upon.
        It would be used to filter data based on the tester details fetched from above call from JWT
         */
        final List<TestRequest> byTester = testRequestQueryService.findByTester(tester);
